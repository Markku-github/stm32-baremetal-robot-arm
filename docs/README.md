...
- [mvp_validation_coverage.md](mvp_validation_coverage.md): high-level MVP validation coverage map and the boundary between tracked guidance and local run evidence
...
- Read [mvp_validation_coverage.md](mvp_validation_coverage.md) when preparing the remaining MVP closeout validation work.
