...
#define DEBUG_COMMAND_HANDLER_TEST_BASE_HOME_RAD DEBUG_COMMAND_HANDLER_TEST_DEG_TO_RAD(90.0f)
#define DEBUG_COMMAND_HANDLER_TEST_SHOULDER_HOME_RAD 0.0f
#define DEBUG_COMMAND_HANDLER_TEST_ELBOW_HOME_RAD DEBUG_COMMAND_HANDLER_TEST_DEG_TO_RAD(180.0f)
#define DEBUG_COMMAND_HANDLER_TEST_ELBOW_POSE_RAD DEBUG_COMMAND_HANDLER_TEST_DEG_TO_RAD(120.0f)
#define DEBUG_COMMAND_HANDLER_TEST_WRIST_TILT_HOME_RAD DEBUG_COMMAND_HANDLER_TEST_DEG_TO_RAD(180.0f)
...
#define DEBUG_COMMAND_HANDLER_TEST_GRIPPER_HOME_RAD 0.0f
