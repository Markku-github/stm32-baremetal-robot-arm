...
#define ROBOT_ARM_TEST_ELBOW_HOME_RAD ROBOT_ARM_TEST_DEG_TO_RAD(102.857142857f)
...
#define ROBOT_ARM_TEST_WRIST_TILT_HOME_RAD ROBOT_ARM_TEST_DEG_TO_RAD(90.0f)
...
static bool test_robot_arm_init_configures_joints_and_home_pose(void)
{
    ...
    for (joint_index = 0U; joint_index < (uint8_t)ROBOT_ARM_JOINT_COUNT; joint_index++)
    {
        ...
        TEST_ASSERT_FLOAT_CLOSE(
            (joint_index == (uint8_t)ROBOT_ARM_JOINT_ELBOW)
