...
#define BOOT_SELF_TEST_DIRECT_POSE_ELBOW_DEG -10.0f
#define BOOT_SELF_TEST_DIRECT_POSE_WRIST_TILT_DEG 5.0f
#define BOOT_SELF_TEST_DIRECT_POSE_WRIST_ROTATE_DEG -15.0f
